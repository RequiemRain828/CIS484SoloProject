...
else
{
  ...
  $sql = "INSERT INTO Project (Title, Description, LastUpdated, LastUpdatedBy) VALUES (?, ?, NOW(), ?)";
          
  if($stmt = mysqli_prepare($link, $sql)){
  // Bind variables to the prepared statement as parameters
  mysqli_stmt_bind_param($stmt, "sss", $title, $description, $last_updated_by);
    ...
    <div class="col-sm-6 mx-auto">
      <div class="jumbotron" align="center">
        ...
        <div class="form-group">
            <input type="text" name="title" class="form-control" placeholder="Title" id="name">
        </div>    
        <div class="form-group">
...
<script>
function populate() {
  document.getElementById("name").value = "Project1";
  document.getElementById("description").value = "Project to observe mammals";
}
</script>

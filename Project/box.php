    ...
    <div class="collapse navbar-collapse justify-content-center" id="navbarNav" >
        <ul class="navbar-nav">
            ...
            <li class="nav-item dropdown">
                <a class="nav-link dropdown align-bottom" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Projects</a>
            ...
            <li class="nav-item dropdown">
            <a class="nav-link dropdown align-bottom" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" 
            aria-expanded="false">Observations</a>
            <div class="dropdown-menu" aria-labelledby="navbarDropdown">
      ...
      <div class="jumbotron" align="center">
        ...
        <div class="table-responsive-sm">
          <table class="table table-bordered table-dark table-sm">
              <tr class="header">
              <th class="text-center">BoxSerialNumber</th>
              <th class="text-center">BoxName</th>
              <th class="text-center">BatteryStatus</th>
            ...
            while($row = mysqli_fetch_assoc($result)) {
                ...
                echo "<td class=text-center>".htmlspecialchars($row[BoxName])."</td>";
                echo "<td class=text-center>".htmlspecialchars($row[BatteryStatus])."</td>";
                echo "<td class=text-center>".htmlspecialchars($row[AnimalStatus])."</td>";
                echo "<td class=text-center>".htmlspecialchars($row[Active])."</td>";
